...
| PR-4 runtime 派生化          |       ✅ |     ❌ 未闭环 | S03/S04 已补齐 promoted/applied + 统一 lifecycle lease；仍待 D6 Applied compensation（S05）、dispatcher/fake-core（S09）、smoke evidence（S10） |
| **PR-4S 稳定化门**           |       ⏳ | 进行中/未完成 | S01～S04 已完成（S03/S04 工作区已验证）；S05～S10 未完成；不得宣告 PR-4S 完成                                                                   |
...
| S-R8  | PR-4   | D6 compensation 以 Promoted 代替 Applied，不能删除新增键，缺少 patch serialization             | PR-4S + PR-5b                                                                                                                                    |
