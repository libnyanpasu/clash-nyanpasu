 ...
 */
async patchProfile(uid: string, profile: ProfileKind) : Promise<Result<null, string>> {
    try {
...
async createProfile(item: ProfileKind, fileData: string | null) : Promise<Result<null, string>> {
    try {
 ...
 * 
 */
export type LocalProfileBuilder = ({ uid: string | null; 
/**
 * profile item type
 * enum value: remote | local | script | merge
 */
 ...
 * 
 */
export type MergeProfileBuilder = ({ uid: string | null; 
/**
 * profile item type
 * enum value: remote | local | script | merge
 */
...
export type ProfileKind = { Remote: RemoteProfileBuilder } | { Local: LocalProfileBuilder } | { Merge: MergeProfileBuilder } | { Script: ScriptProfileBuilder }
/**
 ...
 * 
 */
export type RemoteProfileBuilder = ({ uid: string | null; 
/**
 * profile item type
 * enum value: remote | local | script | merge
 */
 ...
 * 
 */
export type ScriptProfileBuilder = ({ uid: string | null; 
/**
 * profile item type
 * enum value: remote | local | script | merge
 */
