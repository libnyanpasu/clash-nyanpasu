...
pub struct ClashGuardOverrides {
    ...
    allow_lan: bool,
    mode: Mode,
    external_controller: SocketAddr,
    secret: String,
...
impl Default for ClashGuardOverrides {
    fn default() -> Self {
        Self {
            ...
            external_controller: SocketAddr::from_str("127.0.0.1:9872").unwrap(),
            #[cfg(not(debug_assertions))]
            external_controller: SocketAddr::from_str("127.0.0.1:17650").unwrap(),
