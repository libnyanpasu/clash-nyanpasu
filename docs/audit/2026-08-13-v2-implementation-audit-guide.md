...
> 2026-09-10 更新：PR-5 当前实施状态、daemon 故障恢复和待人工验收项目统一见 [收尾台账](2026-09-10-pr5-closeout.md)。下表仅更新已核对项，其余保留原审计范围。

## 4. 已知限制 / 审计关注点（诚实清单）

| #   | 事项                                                                                                                                                                                                                                                                                                                                                                                                                    | 去向                                                                        |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| L1  | macOS DNS 已接线且有 macOS 编译记录；真实 resolver 生效、恢复及重启清理仍待人工验收                                                                                                                                                                                                                                                                                                                                     | [收尾台账 D01–D03](2026-09-10-pr5-closeout.md)                              |
...
| L3  | 已闭：原 `CoreType` 直通提交，保留 alpha/Meow；Service alpha 实机证据待补                                                                                                                                                                                                                                                                                                                                               | #5182 `37d05306`；收尾台账 M02                                              |
| L4  | 已闭：facade 编排已接线，后由 CoreLifecycleActor 串行持有生命周期工作流                                                                                                                                                                                                                                                                                                                                                 | #5182 `37d05306`、#5201 `cab2330b`                                          |
...
| L9  | 已闭（本应用范围）：ServiceActor 单次处理内 stop → probe → uninstall；生命周期 actor 串行编排，不声称排除第三方客户端                                                                                                                                                                                                                                                                                                   | #5182 `37d05306`；人工 M04                                                  |
| L10 | 已闭源码/发布接线：rc.5 已发布，gitlink `3d990714` 与最低服务版本 rc.5 一致；实际下载/安装待人工检查                                                                                                                                                                                                                                                                                                                    | #5227 `fe0b539e`；人工 M06                                                  |
...
| L13 | 已闭：CoreActor 终态 ShutDown 重放 shutdown 结果；生命周期 actor 合并退出等待者                                                                                                                                                                                                                                                                                                                                         | #5182 `37d05306`、#5201 `cab2330b`                                          |
