...
**范围基线：** `main @ 9886aacc750b691d6abc893808ddaaf9dfb6a538`（`fix(proxy): resolve provider-owned proxies (#4954)`；已包含 PR-4 `#4932`；S01 `daf872d9`；S02 `807f1733`；S03 工作区已验证）
...
| PR-4 runtime 派生化          |       ✅ |     ❌ 未闭环 | 换核锁域（S04）、D6 Applied compensation（S05）、smoke evidence；S03 已补齐 promoted/applied + rollback store |
| **PR-4S 稳定化门**           |       ⏳ | 进行中/未完成 | S01～S03 已完成（S03 工作区已验证）；S04～S10 未完成；不得宣告 PR-4S 完成                                     |
...
| ID    | 来源   | 缺陷                                                                                           | 责任阶段                                                                     |
| ----- | ------ | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| S-R1  | PR-4   | `change_core` 仅持 `rebuild_gate`，未与所有 `CoreManager::run_core()` 调用共享完整生命周期锁域 | PR-4S                                                                        |
